 ...
 * @author Ervin
 */
public class InstitutiiCheckCss {
    ...
    public InstitutiiCheckCss(File CssFile) throws Exception
    {
        
        File institutiipath=new File("F:\\Facultate\\TW\\Proiect\\1\\patterns\\Institutii");
        OpenFolder InstitutiiFolder=new OpenFolder(institutiipath);
        OpenFileContent culori=new OpenFileContent(InstitutiiFolder.getFile(institutiipath, 0));
        //culori.listAllContent();
        OpenFileContent fonturi=new OpenFileContent(InstitutiiFolder.getFile(institutiipath, 1));
