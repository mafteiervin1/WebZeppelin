 ...
 * @author Ervin
 */
public class PrezentareCheckCss {
    ...
    public PrezentareCheckCss(File CssFile) throws Exception
    {
        
        File prezentarepath=new File("F:\\Facultate\\TW\\Proiect\\1\\patterns\\Prezentare");
        OpenFolder PrezentareFolder=new OpenFolder(prezentarepath);
        OpenFileContent culori=new OpenFileContent(PrezentareFolder.getFile(prezentarepath, 0));
        //culori.listAllContent();
        OpenFileContent fonturi=new OpenFileContent(PrezentareFolder.getFile(prezentarepath, 1));
