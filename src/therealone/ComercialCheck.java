...
public class ComercialCheck {
    ...
    public ComercialCheck(File comercialFile) throws Exception
    {
        
        OpenFileContent ofc=new OpenFileContent(comercialFile); 
    ...
    public void printErrors()
    {
        ...
        if(this.searchFlag==0)System.err.println("You should have a searchbar.");
        ...
        if(this.inputFlag<7)System.err.println("It's possible that you will need more informations about your clients.We recommand you to have more boxes in your formulars.");
        if(this.inputFlag>12)System.err.println("You have too more boxes in your formular.");
