...
public class BlogCheck {
    ...
    public BlogCheck(File blogFile)
    {
        OpenFileContent ofc=new OpenFileContent(blogFile); 
    ...
    public void printErrors()
    {
        ...
        if(this.filterFlag==0)System.err.println("You shouldn't have some filters for your webpage.");
