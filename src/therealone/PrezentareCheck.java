...
public class PrezentareCheck {
    ...
    public PrezentareCheck(File prezentareFile) throws Exception
    {
        
        OpenFileContent ofc=new OpenFileContent(prezentareFile); 
    ...
    public void printErrors()
    {
        ...
        {
            if(this.menuHREFflag<3)System.err.println("Your menu doesn’t have so many options. You should add more. ");
            if(this.menuHREFflag>6)System.err.println("You menu have too many options. Try compress them to look more softly. ");
        }
        ...
        if(this.inputFlag!=0)System.err.println("You shouldn't have any formular in your site. ");
