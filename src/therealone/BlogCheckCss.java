...
public class BlogCheckCss {
    ...
    public BlogCheckCss(File CssFile) throws Exception
    {
        
        File blogpath=new File("F:\\Facultate\\TW\\Proiect\\1\\patterns\\Blog");
        OpenFolder BlogFolder=new OpenFolder(blogpath);
        OpenFileContent culori=new OpenFileContent(BlogFolder.getFile(blogpath, 0));
        //culori.listAllContent();
        OpenFileContent fonturi=new OpenFileContent(BlogFolder.getFile(blogpath, 1));
